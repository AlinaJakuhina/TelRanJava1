...
public class Main {
    public static void main(String[] args) {
        ...
        //   Cars berlin_cars = new Cars();
        //   System.out.println(berlin_cars.getModel_outside());
        //   berlin_cars.setModel_outside("bmw");
        //   System.out.println(berlin_cars.getModel_outside());
        ...
        //   Cat cat = new Cat();
        //   Cat cat2 = new Cat(10);
        //   Cat cat3 = new Cat(12 ,"Bob");
        //   Cat cat4 = new Cat("Bob",12);
